 <!-- Preloader Start -->
    <div class="preloader">
        <div class="loading-container">
            ...
            <div id="loading-icon"><img src="images/logo/icon.webp" alt=""></div>
        </div>
    </div>
                    ...
                    <div class="topbar-contact-info">
                        <ul>
                            <li><a href="#"><i class="fa-solid fa-clock"></i> <span>Working Hour:</span> 08:00am to
                                    06:00pm</a></li>
                            <li><a href="mailto:info@biomarcbiologics.com"><i class="fa-solid fa-envelope"></i>
                                    <span>Email:</span> info@biomarcbiologics.com</a></li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6 col-md-3">
                    ...
                    <div class="topbar-social-details">
                        ...
                        <div class="topbar-contact-info topbar-contact-details">
                            <ul>
                                <li><a href="tel:+919833690049"><span>Contact:</span> +91-9833690049</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="nav-menu-wrapper">
                            <ul class="navbar-nav mr-auto" id="menu">
                                ...
                                <li class="nav-item highlighted-menu"><a class="nav-link"
                                        href="partnership.html">Partnership</a></li>
                            </ul>
                        </div>
